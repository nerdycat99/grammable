...
RSpec.describe GramsController, type: :controller do
	...
	describe "grams#destroy action" do
		...
		it "should not let a user destroy a gram created by someone else" do
		...
		it "should not let an unauthenticated user delete a gram" do
			gram = FactoryBot.create(:gram)
			delete :destroy, params: { id: gram.id }
	...
	describe "grams#update action" do
		...
		it "should not let a user update a gram created by someone else" do
			gram = FactoryBot.create(:gram)
			user = FactoryBot.create(:user)
			sign_in user
			patch :update, params: { id: gram.id, gram: { message: 'Hello Again' } }
			expect(response).to have_http_status(:forbidden)
		end

		it "should not let an unauthenticated user update a gram" do
			gram = FactoryBot.create(:gram)
	...
	describe "grams#edit action" do
		...
		it "should not let a user edit a gram created by someone else" do
			gram = FactoryBot.create(:gram)
			user = FactoryBot.create(:user)
			sign_in user
		...
		it "should not let an unauthenticated user edit a gram" do
			gram = FactoryBot.create(:gram)
			get :edit, params: { id: gram.id }
			expect(response).to redirect_to new_user_session_path
		end
	...
	describe "grams#show action" do
		...
		it "should return a 404 error if teh gram is not found" do
			get :show, params: { id: 'TACOCAT99' }
			expect(response).to have_http_status(:not_found)
		end
	end
	...
	describe "grams#new action" do
		it "should require that a user is logged in" do
			get :new
			expect(response).to redirect_to new_user_session_path
		end
	...
	describe "grams#create action" do
		...
		it "should handle vailidation errors" do
			user = FactoryBot.create(:user)
			sign_in user
